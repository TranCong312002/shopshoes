          ...
          <div className="w-[25%] px-[15px] pb-[30px]">
            ...
            <ul className="grid  grid-cols-2 text-[14px] text-[#a4a4a4]">
              <li className="cursor-pointer hover:text-primary transition-all">
                <MenuFooter name="Trang chủ" to="/" />
              </li>
              <li className="cursor-pointer hover:text-primary transition-all">
                <MenuFooter name="Giới thiệu" to="/gioi-thieu" />
              </li>
              <li className="cursor-pointer hover:text-primary transition-all">
                <MenuFooter name="Giày nữ" to="/giay-nu" />
              </li>
              <li className="cursor-pointer hover:text-primary transition-all">
                <MenuFooter name="Giày nam" to="/giay-nam" />
              </li>
              <li className="cursor-pointer hover:text-primary transition-all">
                <MenuFooter name="Giày trẻ em" to="/giay-tre-em" />
              </li>
              <li className="cursor-pointer hover:text-primary transition-all">
                <MenuFooter name="Tin tức" to="/news" />
              </li>
              <li className="cursor-pointer hover:text-primary transition-all">
                <MenuFooter name="Liên hệ" to="/contacts" />
              </li>
            </ul>
          </div>
